...
public class MainActivity extends ApptentiveActivity implements OnSurveyAvailableListener {
    ...
    @Override
    public void onSurveyAvailable(final LaunchableSurvey survey) {
        SuperCardToast superCardToast = new SuperCardToast(this, SuperToast.Type.BUTTON);
        superCardToast.setText(getString(R.string.survey_available));
        ...
        superCardToast.setButtonIcon(SuperToast.Icon.Dark.INFO, getString(R.string.open));
        superCardToast.setOnDismissWrapper(new OnDismissWrapper("dismissSurvey", new SuperToast.OnDismissListener() {
            @Override
            public void onDismiss(View view) {
                survey.hide();
            }
        }));
        superCardToast.setOnClickWrapper(new OnClickWrapper("launchSurvey", new SuperToast.OnClickListener() {
            @Override
