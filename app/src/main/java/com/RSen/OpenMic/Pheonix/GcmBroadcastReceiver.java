    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!extras.isEmpty()) {  // has effect of unparcelling Bundle
            ...
            if (GoogleCloudMessaging.
                ...
                builder.setContentTitle(context.getString(R.string.support_message_received));
                builder.setContentText(context.getString(R.string.support_request_received_message));
